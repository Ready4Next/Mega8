...
InputDialog::InputDialog(const wxString &CurrentProfile, wxWindow* parent,wxWindowID id, const wxPoint& pos, const wxSize& size)
{
	...
	SetClientSize(wxSize(727,449));
	BoxKeypad = new wxStaticBox(this, ID_STATICBOX3, _(" Keyboard Mapping"), wxPoint(256,152), wxSize(464,248), 0, _T("ID_STATICBOX3"));
	StaticBox1 = new wxStaticBox(this, ID_STATICBOX1, _(" Keyboard Configuration "), wxPoint(8,8), wxSize(712,88), 0, _T("ID_STATICBOX1"));
	StaticBox2 = new wxStaticBox(this, ID_STATICBOX2, _(" Original keypad "), wxPoint(8,152), wxSize(224,248), 0, _T("ID_STATICBOX2"));
	BtnReset = new wxButton(this, ID_BUTTON1, _("Reset Configuration"), wxPoint(8,408), wxSize(176,32), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	BtnCancel = new wxButton(this, ID_BUTTON2, _("Cancel"), wxPoint(496,408), wxSize(117,32), 0, wxDefaultValidator, _T("ID_BUTTON2"));
	BtnOk = new wxButton(this, ID_BUTTON3, _("Ok"), wxPoint(616,408), wxSize(101,32), 0, wxDefaultValidator, _T("ID_BUTTON3"));
	SBKeypad = new wxStaticBitmap(this, ID_STATICBITMAP1, wxNullBitmap, wxPoint(16,176), wxSize(208,216), wxSIMPLE_BORDER, _T("ID_STATICBITMAP1"));
	...
	PanelKeypad = new wxPanel(this, ID_PANEL1, wxPoint(272,176), wxSize(432,216), wxTRANSPARENT_WINDOW|wxTAB_TRAVERSAL, _T("ID_PANEL1"));
	StaticText2 = new wxStaticText(this, ID_STATICTEXT3, _("To set another key, just mouse over the corresponding box you want to change and press the new key !"), wxPoint(8,128), wxSize(712,16), wxALIGN_CENTRE, _T("ID_STATICTEXT3"));
...
void InputDialog::LoadKeypad(const wxString &profile)
{
    ...
    if (profile != wxEmptyString && CheckDirty()) {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            ae->Set(wxACCEL_NORMAL, Mega8Config::getInstance().getKey(KeypadCorrespondingIndex[i]), 0);
